  ...
  return (
    <footer className="bg-white py-12 px-6 font-sans tracking-wide">
      <div className="flex flex-col items-center gap-6">
        ...
        <hr className="border-[#A04747] w-full mx-[20px] md:mx-[100px]" />

        <ul className="flex flex-wrap gap-x-5 gap-4 ">
          <li><a href="javascript:void(0)" className="text-[#A04747] hover:underline  text-base transition-all">Terms of Service</a></li>
          <li><a href="javascript:void(0)" className="text-[#A04747] hover:underline  text-base transition-all">Privacy Policy</a></li>
          <li><a href="javascript:void(0)" className="text-[#A04747] hover:underline  text-base transition-all">Contact</a></li>
        </ul>
      </div>
    </footer>
