...
const Contact = () => {
  return (
    <>
      <section className="pt-32 relative z-10 overflow-hidden py-10 px-[10px] md:px-[200px]">
        ...
        <div className="flex flex-col md:flex-row gap-5 md:gap-10 justify-between items-start md:items-center">
          <div className="md:p-5 md:w-1/2">
            <div className="mb-10 flex gap-2 justify-between items-center">
              ...
              <div className="w-full">
                <h4 className="mb-1 text-2xl font-bold text-dark">
                  Our Location
                </h4>
                <p className="text-xl text-dark">Tokyo,Japan.</p>
              </div>
            </div>
            <div className="mb-10 flex gap-2 justify-between items-center">
              <div>
          ...
          <div className="relative md:w-1/2 rounded-lg p-5 md:p-20 shadow-lg">
            <form>
              <ContactInputBox
                type="text"
                name="name"
